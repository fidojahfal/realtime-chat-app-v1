-- CreateEnum
CREATE TYPE "Conversation_Type" AS ENUM ('PRIVATE');
...
-- AddForeignKey
ALTER TABLE "Conversation_participant" ADD CONSTRAINT "Conversation_participant_conversationId_fkey" FOREIGN KEY ("conversationId") REFERENCES "Conversation"("id") ON DELETE SET NULL ON UPDATE CASCADE;
